...
export default class Detail extends React.Component {
  ...
  Teslim =  async () => {
    try {
      const response = await fetch('http://192.168.248.2/reactapp/Deleteproduct.php?code='+global.ddata.veri[1].productCode+'&location='+global.ddata.veri[1].productLocation+'&shortLocation='+global.ddata.veri[1].shortLocation, {
        method: 'GET',
        headers: {
  ...
  Listele = async () => {
    try {
      const response = await fetch('http://192.168.248.2/reactapp/Delivererpage.php', {
        method: 'GET', 
        headers: { 
          Accept: 'application/json',
          'Content-Type': 'application/json',
